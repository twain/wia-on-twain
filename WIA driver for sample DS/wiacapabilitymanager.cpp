...
HRESULT CWIACapabilityManager::Initialize(__in HINSTANCE hInstance)
{
...
HRESULT CWIACapabilityManager::AllocateCapability(__out WIA_DEV_CAP_DRV **ppWIADeviceCapability)
{
    HRESULT hr = E_INVALIDARG;
...
void CWIACapabilityManager::FreeCapability(__in WIA_DEV_CAP_DRV *pWIADeviceCapability, 
